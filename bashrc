...
if [ -d "$HOME/.config/doom-emacs/bin" ] ;
  then PATH="$HOME/.config/doom-emacs/bin:$PATH"
fi
...
#
alias fixgp="sudo rm -R /var/lib/pacman/sync && sudo -E pacman -Syyuu"

#
alias fixclock='echo sudo date -s "12 Jul 2022 14:03"'
...
alias emspace='emacs --with-profile spacemacs'
...
alias playwav='moc *.wav'
alias playogg='moc *.ogg'
alias playmp3='moc *.mp3'
...
# Play video files in current dir by type
alias mplayavi='mpv *.avi'
alias mplaymov='mpv *.mov'
alias mplaymp4='mpv *.mp4'
