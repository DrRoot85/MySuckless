...
static const char *kbbrightnessupcmd[]  = { "doas ", "macbook-lighter-kbd", " --inc", " 50", NULL };
static const char *kbbrightnessdowncmd[]  = { "doas ", "macbook-lighter-kbd", " --dec", " 50", NULL };
...
static Key keys[] = {
	...
	{ 0, XF86KbdBrightnessUp,		spawn,		{.v = kbbrightnessupcmd } },
	{ 0, XF86KbdBrightnessDown,		spawn,		{.v = kbbrightnessdowncmd } },
};
